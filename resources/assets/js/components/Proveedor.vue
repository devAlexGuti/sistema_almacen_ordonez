        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                    ...
                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                        <div class="card-body">
                            ...
                            <div class="input-group input-group-lg mb-3">
                                ...
                                <input @keypress="soloLetras($event);" onpaste="return false" type="text" maxlength="100" ref="nombre" v-model="nombre" class="form-control" :class="{'border-danger' : nombre==''}" placeholder="Ingrese nombre del proveedor">
                            ...
                            <div class="input-group input-group-lg mb-3">
                                ...
                                <select v-model="tipo_documento" class="form-control" ref="tipo_documento">
                            ...
                            <div class="input-group input-group-lg mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">
                                        <i class="fa fa-phone fijo"></i>
                                    </span>
                                </div>
                                <input type="text" @keypress="soloNumeros($event);" maxlength="9" onpaste="return false" v-model="telefono" class="form-control" placeholder="Ingrese teléfono">
                            </div>
                            <div class="input-group input-group-lg mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">
                                ...
                                <input @blur="validar" ref="email" id="email" type="email" v-model="email" class="form-control" :class="{'border-danger' : alto}" placeholder="Ingrese correo ejemplo@gmail.com">
                            ...
                            <div class="input-group input-group-lg mb-3">
                                ...
                                <input type="text" @keypress="soloLetras($event);" onpaste="return false" v-model="contacto" class="form-control" placeholder="Ingrese nombre del contacto">
                            </div>
                            ...
                            <div class="input-group input-group-lg mb-3">
                                ...
                                <input type="text" @keypress="soloNumeros($event);" maxlength="9" onpaste="return false" v-model="telefono_contacto" class="form-control" placeholder="Ingrese celular del contacto">
                            </div>
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <button type="button" v-if="tipoAccion==1" class="btn btn-primary" @click="registrarPersona()"><i class="fa fa-save"></i>&nbsp;Guardar Proveedor</button>
                    <button type="button" v-if="tipoAccion==2" class="btn btn-primary" @click="actualizarPersona()"><i class="fa fa-save"></i>&nbsp;Actualizar Proveedor</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
    ...
    export default {
        ...
        methods : {
               ...
               if (this.validarPersona()){
                ...
                axios.put('/proveedor/actualizar',{
                    ...
                    swal({
                            type: 'success',
                            title: 'Actualizado!',
                            text: 'Los Datos del Proveedor ha sido Actualizado Correctamente!',
                    })
                }).catch(function (error) {
                    console.log(error);
                    swal({
            ...
            validarPersona(){
                ...
                if (!this.nombre) {
                    this.errorMostrarMsjPersona.push("El nombre del proveedor no puede estar vacío.");
